...
class CfgMods {
	class DayZ {
		...
		name = "Dayz Battle Royale Public Beta";
		picture = "z\addons\br_assets\screen\mod.paa";
		hidePicture = 0;
		hideName = 0;
		action = "www.dayzbattleroyale.com";
		version = "0.8.1";
		hiveVersion = 0.96;
...
class CfgAddons {
	...
	class PreloadAddons	{
		class dayz {
			list[] = {"dayz_code","dayz","dayz_equip","dayz_communityassets","dayz_weapons","dayz_sfx","ST_bunnyhop","st_collision","st_evasive","objets_idc"};
		};
	};
};
