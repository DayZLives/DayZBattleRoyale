...
while {true} do {
    ...
    if(_isPlayerOutside) then {
		...
		sleep 5;
        titleText ["IF YOU ARE IN A VEHICLE, THE ENGINE WILL BLOW AND YOU WILL BE INFECTED!", "PLAIN"];
		sleep 5;
        titleText ["YOU WILL ALSO LOSE 400 BLOOD FOR EVERY 20 SECONDS YOU REMAIN OUTSIDE!", "PLAIN"];
        sleep 30;
