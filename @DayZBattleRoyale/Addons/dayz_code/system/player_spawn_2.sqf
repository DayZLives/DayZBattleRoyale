...
*/
	...
	dayz_hunger = dayz_hunger + (_hunger / 20);
	...
	dayz_thirst = dayz_thirst + (_thirst / 20) * (dayz_temperatur / dayz_temperaturnormal);	//TeeChange Temperatur effects added Max Effects: -25% and + 16.6% waterloss
