...
if (!isDedicated) then {	
	...
	onPreloadFinished {
		...
		[50,300,200,100,100] execVM "\br_code\scripts\tpw_park.sqf";
		[100,500,10,1,5] execVM "\br_code\scripts\tpw_fall.sqf";
		[5,1000,15,2,0] execVM "\br_code\scripts\tpw_cars.sqf";
		//0 = [4,0.8,0.85,0.95] execVM "\br_code\scripts\tpw_bleedout.sqf";
