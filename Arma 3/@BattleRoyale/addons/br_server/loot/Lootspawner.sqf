...
_spInterval = 600;					//Time (in sec.) to pass before an building spawns new loot
_chfullfuel = 35;					//Chance (in %) of a spawned fuelcan to be full instead of empty
_genZadjust = 0.5;					//High adjustment (in engine units) thats generally added to every spawnpoint
_tmpTstPlace = [4000, 4000, 0];	//Coord's, in [x,y,z] of a preferably flat and unocupied piece of land
