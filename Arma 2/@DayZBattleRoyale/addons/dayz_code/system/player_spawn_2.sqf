...
while {true} do {
	...
	*/
	...
	dayz_hunger = dayz_hunger + (_hunger / 15);
	...
	dayz_thirst = dayz_thirst + (_thirst / 15) * (dayz_temperatur / dayz_temperaturnormal);	//TeeChange Temperatur effects added Max Effects: -25% and + 16.6% waterloss
