...
class CfgMods
{
	class DayZ
	{
		...
		name = "DayZ Battle Royale Beta";
		picture = "z\addons\br_assets\screen\mod.paa";
		hidePicture = 0;
		hideName = 0;
	...
	class PreloadAddons
	{
		class dayz
		{
			list[] = {
						...
						"KPFS_UAZ451","SWM_SwissArms","SWM_Misc","unleashed_equip","unleashed_skins","unleashed_vehicles",
						"KPFS_G36","KPFS_G3","KPFS_P38","KPFS_MPi74","KPFS_SKS",
...
class CfgSurvival {
	class Inventory {
		class Default {
			RandomMagazines = 0;
			weapons[] = {}; //8Rnd_9x18_Makarov
			GuaranteedMagazines[] = {};
			RandomPossibilitieMagazines[] = {};//weapons[] = {"HandRoadFlare"};
