...
#include "owcleanup.sqf";
	...
	//spawn vehicles
	call compile preProcessFileLineNumbers "\z\addons\dayz_server\vehicles\hgspawns.sqf";
	//spawn start position
	call compile preProcessFileLineNumbers "\z\addons\dayz_server\buildings\hgmain.sqf";
	//spawn trees
	call compile preProcessFileLineNumbers "\z\addons\dayz_server\buildings\hgtrees.sqf";
	
	//spawn backpacks
	call compile preProcessFileLineNumbers "\z\addons\dayz_server\backpacks\placebackpacks.sqf";
